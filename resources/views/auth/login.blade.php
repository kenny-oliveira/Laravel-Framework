...
function formatCpf(value)
{
 ...
 var cnpjCpf = value.replace(/\D/g, '');
  if (cnpjCpf.length === 11) {
    ...
    document.getElementById('cpf').value = cnpjCpf;
    document.getElementById('cpf').style.border = '0px'
    }
}
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cpf" type="text" class="form-control @error('cpf') is-invalid @enderror" maxlength="11" oninput="formatCpf()" name="cpf" value="{{ old('cpf') }}" required autofocus>
